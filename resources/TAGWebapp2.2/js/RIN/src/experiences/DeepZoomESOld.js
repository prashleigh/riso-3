...
(function (rin, ko) {
    /*globals Seadragon:true, $:true, ko:true*/
    "use strict";
    ...
    var DeepZoomES = function (orchestrator, esData) {
        ...
        $(this._userInterfaceControl).bind("mousedown mousewheel", function () {
    ...
    DeepZoomES.prototypeOverrides = {
        ...
        load: function (experienceStreamId) {
            ...
            function openDzi(dzi) {
                self._viewer.addEventListener('open', function (openedViewer) {
                    self._viewer.addEventListener('animation', function () { self.raiseViewportUpdate(); });
                    self._viewer.addEventListener('animationstart', function () { self.raiseViewportUpdate(); });
                    self._viewer.addEventListener('animationfinish', function () { self.raiseViewportUpdate(); });
                ...
                self._viewer.addEventListener('error', function () {
        ...
        _updateViewportClip: function (viewer) {
            ...
            if (this.viewportClampingMode !== this.viewportClampingOptions.none) {
                var adjOffset = 0, percentageAdjustment, proportionalWidth, proportionalHeight;
                if (viewer.source.height <= viewer.source.width) {
                    if (this.viewportClampingMode === this.viewportClampingOptions.all) {
                        ...
                        proportionalWidth = viewer.source.width * percentageAdjustment;
                    ...
                    if (this.viewportClampingMode === this.viewportClampingOptions.all) {
                        ...
                        proportionalHeight = viewer.source.height * percentageAdjustment;
