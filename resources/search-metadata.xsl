...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  "link": "http://library.brown.edu/find/Search/Results?lookfor=<xsl:value-of select="/mods:mods/mods:titleInfo[not(@type)]/mods:title"/>&amp;type=AllFields&amp;filter[]=collection%3A%22Garibaldi+and+the+Risorgimento%22&amp;view=list"
})</xsl:template>
</xsl:stylesheet>
